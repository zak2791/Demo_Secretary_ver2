...
System_0::System_0(int _id,
    ...
    finalItem = new System_0_Final(lAthlete, "");
    ...
    connect(commonRoundItem, SIGNAL(sigPlace(QString)), this, SLOT(savePlace(QString)));
    connect(commonRoundItem, SIGNAL(sigPlace(QString)), finalItem, SLOT(setAthletes(QString)));
...
void System_0::savePlace(QString data)
{
    //emit sigSaveData(id, id_system, 0, data);
}
